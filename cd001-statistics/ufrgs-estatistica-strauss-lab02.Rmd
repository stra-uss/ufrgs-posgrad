...
-   O livro contém uma estrutua didática na qual evolui, passo a passo, para o entendimento dos úteis e necessários conceitos e técnicas estatíscas para nao estatísticos.
-   Na área de exatas, no que se refere à engenharia, a estatística sempre está presente. No âmbito da análise de dados, seu uso é essencial. Sem estatítica não há ciência.
